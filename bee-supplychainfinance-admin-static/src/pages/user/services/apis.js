export default {
  ...
  getList: {
    api: (url) => `/api/user/list?${url}`,
    type: 'POST'
  },
  getUserInfo: {
    api: (id) => `/api/user/list/${id}`,
    type: 'GET'
  },
  getRegion: {
  ...
  getAdminUserById: {
    api: (userId) => `/supplychainfinance-user/user/getAdminUserById?userId=${userId}`,
    type: 'GET'
  },
  getMiddleUserById: {
    api: (userId) => `/supplychainfinance-user/user/getMiddleUserById?userId=${userId}`,
    type: 'GET'
  },
  editAdmin: {
    api: () => `/supplychainfinance-user/user/edit/admin/account`,
    type: 'POST'
  },
  saveUserInfo: {
    api: () => '/api/user/list/update',
    type: 'POST'
  },
  editAccountStatus: {
