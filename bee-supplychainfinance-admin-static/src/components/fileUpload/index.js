...
class FileUpload extends React.Component {
  ...
  render() {
    const upLoadProps = {
      name: "file",
      action: `${baseUrls.domain}/supplychainfinance-common/file/upload?type=${
        this.props.type
        }`,
      headers: {
        ...
        sysToken: sessionStorage.sysToken, beeRouter: window.location.pathname,
        financeToken: sessionStorage.financeToken
      },
