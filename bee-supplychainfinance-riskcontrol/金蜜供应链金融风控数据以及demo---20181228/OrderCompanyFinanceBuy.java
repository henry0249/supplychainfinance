...
@Document(indexName = "index-risk-order_company_finance_buy", type = "order_company_finance_buy" , shards = 4, replicas = 1)
public class OrderCompanyFinanceBuy {
    ...
    private Long entrustBuyDetailId;
    /**
     * 企业类型(1委托企业 2担保公司 3供应商)
     */
