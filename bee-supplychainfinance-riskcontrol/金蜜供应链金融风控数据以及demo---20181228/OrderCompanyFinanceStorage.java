...
@Document(indexName = "index-risk-order_company_finance_storage", type = "order_company_finance_storage", shards = 4, replicas = 1)
public class OrderCompanyFinanceStorage {
