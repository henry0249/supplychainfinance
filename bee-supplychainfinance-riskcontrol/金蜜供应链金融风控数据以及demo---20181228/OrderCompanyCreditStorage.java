...
@Document(indexName = "index-risk-order_company_credit_storage", type = "order_company_credit_storage" , shards = 4, replicas = 1)
public class OrderCompanyCreditStorage {
