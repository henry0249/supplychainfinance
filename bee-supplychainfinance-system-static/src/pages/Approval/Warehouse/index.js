...
const api = `${baseUrls.domain}/supplychainfinance-audit/storageStorehouseBillProof/applies`;
...
export default class Index extends Component {
  ...
  handleJump = (type, id) => {
    ...
    router.push(`/approval/warehouse/details?enterType=0&type=warehouse&key=bill&id=${id}`)
  }
    ...
    return (
      <div className={styles.container}>
        <div className={styles.crumb}>
          <Breadcrumb>
            <Breadcrumb.Item>仓单审批管理</Breadcrumb.Item>
          </Breadcrumb>
        </div>
        ...
        <div className={styles.body}>
          ...
          <Form className={styles.form} layout='inline'>
            <FormItem label='委托企业'>
              {
                getFieldDecorator('entrustCompany')(
