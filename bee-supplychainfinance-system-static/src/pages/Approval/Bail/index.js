...
const api = `${baseUrls.domain}/supplychainfinance-audit/BondProofExamine/applies`;
...
export default class Index extends Component {
  ...
  handleJump = (type, id) => {
    ...
    router.push(`/approval/bail/details?enterType=0&type=bail&key=bill&id=${id}`)
  }
    ...
    return (
      <div className={styles.container}>
        <div className={styles.crumb}>
          <Breadcrumb>
            <Breadcrumb.Item>保证金审批管理</Breadcrumb.Item>
          </Breadcrumb>
        </div>
